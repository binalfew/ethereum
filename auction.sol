...
contract Auction {
    ...
    constructor(address eoa) {
        ...
        endBlock = startBlock + 3; // end auction after 3 transactions
        ipfsHash = "";
    ...
    function finalizeAuction() public {
        ...
        if(auctionState == State.Cancelled) { // Auction cancelled
            ...
            if(msg.sender == owner) { // This is the owner
                ...
                } else { // This is neither the owner or the winner
                    recepient = payable(msg.sender);
                    value = bids[msg.sender];
                }
            } 
        ...
        // reset the bids of the recepient to zero
        bids[recepient] = 0;

        // send value to the recepient
